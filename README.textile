...
*Date:* 2009-03-04<br />
*Author:* Wes Baker<br />
*Mail:* wes@newcityexperience.com<br />
*Web:* "http://www.newcityexperience.com":http://www.newcityexperience.com
...
<pre><code>$('#news').innerfadeNext('#news #next a');</code></pre>This function expects a selector that will select the Next anchor link

<pre><code>$('#news').innerfadePrevious('#news #previous a');</code></pre>This function expects a selector that will select the Previous anchor link
